...
`apartment`, `arcade`, `armory`, `auto_garage`, `backroom_clinic`, `bank`, `bar`, `barracks`, `biotech_clinic`, `bookshop`, `brokerage`, `casino`, `checkpoint`, `chop_shop`, `co_working_hub`, `cold_storage`, `command_center`, `contractor_office`, `corner_store`, `courier_office`, `courthouse`, `data_center`, `daycare`, `factory`, `field_hospital`, `flophouse`, `freight_depot`, `gallery`, `gaming_hall`, `hardware_store`, `hotel`, `house`, `jail`, `junk_market`, `karaoke_box`, `lab`, `laundromat`, `machine_shop`, `media_lab`, `metro_exchange`, `motor_pool`, `music_venue`, `nightclub`, `office`, `outfitter`, `pawn_shop`, `pharmacy`, `pool_hall`, `prison`, `recruitment_office`, `recycling_plant`, `restaurant`, `server_hub`, `service_station`, `soup_kitchen`, `street_kitchen`, `supply_bunker`, `surplus_store`, `tavern`, `tenement`, `theater`, `thrift_store`, `tool_depot`, `tower`, `warehouse`

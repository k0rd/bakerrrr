...
ARCHETYPE_FIELD_DOMAINS = {
    ...
    "drone_shop": ("technology", "repair", "retail"),
    "wire_shop": ("technology", "intel", "retail"),
    "electronics_shop": ("technology", "retail", "repair"),
    "comms_shop": ("technology", "intel", "retail"),
...
CAREER_FIELD_KEYWORDS = {
    ...
    "retail": ("clerk", "counter", "seller", "stock"),
    "technology": ("broadcast", "compute", "data", "drone", "electronics", "editor", "media", "server", "signal", "studio", "technician"),

...
SYMBOLIC_PALETTE: tuple[SymbolicPaletteRow, ...] = (
    ...
    _row("fixture_lamp", (202, 164, 86), 215, "yellow", tags=("fixture", "light")),
    _row("fixture_pole", (132, 106, 82), 137, "yellow", attrs=("dim",), tags=("fixture", "utility")),
    _row("fixture_hydrant", (214, 76, 64), 203, "red", attrs=("bold",), tags=("fixture", "safety")),
    _row("fixture_transit", (72, 134, 202), 75, "blue", attrs=("bold",), tags=("fixture", "transit")),
    _row("fixture_utility", (150, 144, 126), 145, "white", tags=("fixture", "utility")),
    _row("fixture_atm", (58, 126, 180), 74, "blue", attrs=("bold",), tags=("fixture", "service")),
    _row("fixture_claim", (154, 102, 186), 134, "magenta", attrs=("bold",), tags=("fixture", "service")),
    _row("fixture_access", (202, 142, 58), 208, "yellow", attrs=("bold",), tags=("fixture", "security")),
    _row("fixture_hatch", (104, 118, 128), 244, "white", attrs=("dim",), tags=("fixture", "transit")),
    _row("fixture_stairs", (144, 138, 126), 145, "white", tags=("fixture", "transit")),
    _row("fixture_mailbox", (72, 112, 170), 68, "blue", tags=("fixture", "street")),
    _row("fixture_camera", (166, 174, 184), 250, "white", tags=("fixture", "security")),
    _row("fixture_alarm", (202, 68, 68), 203, "red", attrs=("bold",), tags=("fixture", "security")),
    _row("fixture_way_marker", (174, 150, 92), 179, "yellow", tags=("fixture", "route")),
    _row("fixture_solar", (72, 110, 158), 68, "blue", tags=("fixture", "utility")),
    _row("fixture_vending", (194, 84, 88), 167, "red", tags=("fixture", "service")),
    _row("fixture_charging", (62, 158, 164), 80, "cyan", attrs=("bold",), tags=("fixture", "service")),
    _row("fixture_terminal", (82, 124, 178), 68, "blue", tags=("fixture", "service")),
    _row("fixture_security", (90, 102, 126), 60, "blue", tags=("fixture", "security")),

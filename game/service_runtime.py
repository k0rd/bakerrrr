...
CASINO_GAME_PROFILES = {
    ...
    "texas_holdem_cash": {
        ...
        "service_label": "Texas hold'em cash",
        "menu_label": "Join the hold'em cash table",
        "bet_options": (100,),
        "prompt": "Take a real chair at the live table. Blinds keep moving while the casino lives around you.",
        "note": "Eight spatial seats, autonomous players, continuous hands, and no pause between the felt and the world.",
        "social_gain": (2, 6),
    },
    "plinko": {
        "title": "Plinko",
...
CASINO_GAME_CAPABILITY_OVERRIDES = {
    ...
    "texas_holdem_cash": {
        ...
        "supports_multiplayer_seats": True,
        "supports_offscreen_resolution": True,
        "supports_player_vs_player": True,
        "supports_debt": False,
        "risk_band": "high",
        "pace": "live",
        "social_texture": "poker",
        "style_tags": ("cards", "holdem", "cash", "multiplayer", "spatial", "persistent"),
    },
    "plinko": {
        "supports_backroom_access": False,
        "risk_band": "medium",

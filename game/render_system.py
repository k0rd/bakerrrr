...
from game.ui_text_runtime import (
    ...
    _opportunity_notebook_detail_lines,
    _opportunity_notebook_list_line,
    _line_segments,
    _line_text,
    _line_with_prefix,
    _log_display_line,
    ...
    def update(self):
        ...
        if inventory_ui.get("open"):
            ...
            _report_debug_ui.draw_report_modal(
                ...
                opportunity_list_line_fn=_opportunity_notebook_list_line,
                opportunity_detail_lines_fn=_opportunity_notebook_detail_lines,
                sim=self.sim,
                modal_theme=modal_theme,

    ...
    STORE_PROFILES = {
        ...
        "tool_depot": {
            ...
            "item_pool": (
                ...
                ("scrap_circuit", 10),
                ("wire_spool", 14),
                ("salvaged_hardware", 12),
                ("spring_clamp", 8),
                ("tripline_alarm_plan", 5),
                ("restraint_snare_plan", 3),
                ("signal_jammer", 8),
                ("padded_jacket", 10),
                ("bandage_roll", 10),
                ("caff_shot", 10),
        ...
        "hardware_store": {
            ...
            "item_pool": (
                ...
                ("scrap_circuit", 10),
                ("wire_spool", 16),
                ("salvaged_hardware", 14),
                ("spring_clamp", 9),
                ("tripline_alarm_plan", 6),
                ("restraint_snare_plan", 3),
                ("signal_jammer", 6),
                ("padded_jacket", 12),
                ("courier_mesh", 10),
        ...
        "salvage_camp": {
            ...
            "item_pool": (
                ...
                ("battery_pack", 18),
                ("wire_spool", 18),
                ("salvaged_hardware", 20),
                ("spring_clamp", 12),
                ("tripline_alarm_plan", 4),
                ("restraint_snare_plan", 3),
                ("remote_release_rig_plan", 2),
                ("decoy_beacon_plan", 3),
                ("pocket_multitool", 14),
                ("hotwire_leads", 12),
                ("signal_jammer", 10),

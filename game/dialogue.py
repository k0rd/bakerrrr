    ...
    "job_feel": (
        {
            ...
            "npc_warm": (
                ...
                "{rapport_job_note} It feels good to do it well.",
            ),
            "npc_rebuff": (
                "I'd rather not get into how I feel about it.",
                "I don't really know you well enough to tell you how I feel about work yet.",
            ),
        },
        {
            ...
            "npc_rebuff": (
                ...
                "Let's leave it at what I do for now.",
            ),
        },
    ),
    "routine": (
...
AREA_STYLE_HINTS = {
    "city": {
        ...
        "idioms": (
            ...
            "You run into the same people sooner or later.",
        ),
        "local_terms": (
            "People notice. Whether they'll say so is another matter.",
    ...
    "frontier": {
        ...
        "catch_phrases": (
            "You learn to mend things out here.",
            "Nothing stays easy for long out here.",
            "The frontier holds on to things.",
            "It's a long way to go back for something you forgot.",
        ),
        "idioms": (
            "Ask someone who's been along that road lately.",
            "A long road makes short tempers.",
            "A quiet day out here still has a bill.",
        ),
        "local_terms": (
            "We tend to ask after the road before we ask after you.",
            "If you're passing through, leave the gate as you found it.",
    ...
    "coastal": {
        ...
        "idioms": (
            "You can't hurry the tide.",
            "Someone on the docks will have heard about it.",
            "Storm talk makes people generous with bad guesses.",
        ),
        "local_terms": (
            "We plan around the boats here.",
            "News usually comes in with someone else's cargo.",
            "Waiting's easier if you've got company.",
        ),
    },
    "wilderness": {
        "farewell_tags": (
        ...
        "idioms": (
            "It's good to hear another voice sometimes.",
            "A cold trail still tells on somebody.",
            "The quiet has a way of counting footsteps.",
        ),
        "local_terms": (
            "We pass on news when we meet. It might be a while till next time.",
            "You get used to looking for signs of company.",
...
DISTRICT_STYLE_HINTS = {
    "industrial": {
        ...
        "idioms": (
            "Better to fix it before the next shift has to.",
            "A repair doesn't get cheaper while you put it off.",
            "If the floor goes quiet, listen harder.",
        ),
        "local_terms": (
            "You look after the people working beside you.",
            "Tell the next shift what needs doing. Saves everyone trouble.",
        ),
        "address_terms": (
            "friend",
            "mate",
    ...
    "residential": {
        ...
        "idioms": (
            "News gets around before you've put the kettle on.",
            "It's easier living here if you say hello now and then.",
            "Someone always has time to look out the window.",
        ),
        "local_terms": (
            "We still have to live next door to each other afterward.",
            "You knock before you borrow something. Even if you know them.",
        ),
        "address_terms": (
            "neighbor",
            "friend",
    ...
    "downtown": {
        ...
        "idioms": (
            "Walk with me if you want to talk.",
            "Everyone's trying to get somewhere by lunch.",
            "If it matters downtown, somebody already priced it.",
        ),
        "local_terms": (
            "People will give you directions without breaking stride.",
            "Nobody thinks they have time to wait here.",
        ),
        "address_terms": (
            "friend",
            "chief",
    ...
    "slums": {
        "catch_phrases": (
            ...
            "I remember who helped when I had nothing.",
        ),
        "idioms": (
            "You don't forget someone sharing their last bit with you.",
            "Find out what they want before you say yes.",
            "Thin pockets still remember who helped.",
        ),
        "local_terms": (
            "If you can't pay someone back, help when you can.",
            "Don't promise what you haven't got.",
            "A little help goes a long way here.",
        ),
        "address_terms": (
            "friend",
            "pal",
    ...
    "corporate": {
        ...
        "idioms": (
            "It's worth knowing who's responsible.",
            "People are careful about what goes on the record.",
            "Policy is just a locked door with nicer shoes.",
        ),
        "local_terms": (
            "A verbal agreement won't get you very far here.",
            "We tend to ask who approved it first.",
        ),
        "address_terms": (
            "friend",
            "associate",
    ...
    "military": {
        ...
        "idioms": (
            "Make sure the next person gets the message.",
            "If you're unsure, ask.",
            "Doing it twice takes longer.",
        ),
        "local_terms": (
            "Names and times. That's what people will ask for.",
            "Say what happened. Keep the guesses separate.",
        ),
        "address_terms": (
            "citizen",
            "friend",
    ...
    "entertainment": {
        ...
        "idioms": (
            "A story grows every time someone tells it backstage.",
            "People remember a bad night longer than you'd like.",
            "The room loves a secret until it owns one.",
        ),
        "local_terms": (
            "You thank the people clearing up, too.",
            "Wait till someone's offstage before you bother them.",
        ),
        "address_terms": (
            "friend",
            "dear",
    ...
    "transit": {
        "catch_phrases": (
            "Miss one connection and the whole day changes.",
            "Every platform has a listener.",
            "The schedule tells one truth and people tell another.",
        ),
        "idioms": (
            "Platform talk moves in loops.",
            "A story gets muddled after a few changes of train.",
            "A missed stop can still follow you.",
        ),
        "local_terms": (
            "Ask where someone came from before you trust their directions.",
            "You can get to know someone quite well waiting for the same train.",
        ),
        "address_terms": (
            "friend",
            "traveler",
    ...
    "tourist": {
        ...
        "idioms": (
            "Everyone gets turned around their first time here.",
            "The pictures always leave something out.",
        ),
        "local_terms": (
            "It's worth leaving yourself time to wander.",
            "Ask someone who lives here where they go on a day off.",
        ),
        "address_terms": (
            "friend",
            "traveler",
...
DIALOGUE_BANKS = {
    ...
    "history": (
        ...
        "The short version? {history_summary}",
        "Well. {history_summary}",
        "Oh, let's see. {history_summary}",
    ),
    "history_none": (
    ...
    "routine": (
        ...
        "My usual day? {routine_summary}",
        "Well, let's see. {routine_summary}",
    ),
    "routine_none": (
        "Nothing steady enough to map out.",
        "I don't really have a regular routine.",
        "It changes too much to call it a routine.",
        "One errand after another, mostly.",
        "If I make a plan, the block usually laughs first.",
    ),
    "workplace_first": (
        "You can usually find me at {workplace_name}.",
        "I spend most of my day at {workplace_name}.",
    ...
    "organization": (
        ...
        "Who I work for? {organization_summary}",
        "About the job? {organization_summary}",
    ),
    "organization_none": (
    ...
    "local_opportunity": (
        ...
        "You might be interested in this. {opportunity_summary}",
        "This might give you somewhere to start. {opportunity_summary}",
        "Here's something you could ask about. {opportunity_summary}",
        "I'd be careful, but it's worth asking about. {opportunity_summary}",
    ),
    "local_other_bond": (
    ...
    "local_none": (
        ...
        "I've heard a few things, but nothing I'd send you chasing.",
        "Nothing I can tell you for sure.",
        "Nothing has risen above background trouble yet.",
        "The day is quiet in the way that makes people check twice.",
        "Nothing I'd trust enough to pass on.",
    ),
    "street_talk_local_economy_intro": (
        "No gossip, really. I can tell you a bit about how the shops are doing.",
        "I haven't got much to pass on. Did you want to know about the shops?",
        "I've mostly been hearing about business. I can tell you about that, if you like.",
        "Not much gossip from me. I know a little about business around here, though.",
    ),
    "local_economy_skilled": (
        "Here's what I can tell you from work. {local_economy_summary}",
        "From what I see at work, {local_economy_summary_lc}",
        "Business-wise, {local_economy_summary_lc}",
        "As far as business goes, {local_economy_summary_lc}",
    ),
    "local_economy_familiar": (
        "From being around here, {local_economy_summary_lc}",
        "From what I've seen, {local_economy_summary_lc}",
        "I'd say {local_economy_summary_lc}",
        "Broadly, {local_economy_summary_lc}",
    ),
    "local_economy_rumor": (
        "I only know what people are saying, but {local_economy_summary_lc}",
        "I would not pretend to know the books, but {local_economy_summary_lc}",
        "Don't take my word for it, but here's what I've heard. {local_economy_summary}",
        "From the outside, {local_economy_summary_lc}",
    ),
    "local_economy_none": (
        "I do not know this block well enough to tell you how business is doing.",
        "I'd be guessing. Ask somebody who works in one of the shops.",
        "I would be guessing, and bad business guesses waste everybody's time.",
        "I'd be guessing. I don't know the shops around here.",
    ),
    ...
    "social_knowledge": (
        ...
        "I'd rather you didn't say who told you. {social_knowledge_summary}",
    ),
    "social_knowledge_incident": (
    ...
    "social_knowledge_business": (
        ...
        "People have been saying this: {social_knowledge_summary_lc}",
    ),
    "social_knowledge_opportunity": (
        "If you're looking for something to do, {social_knowledge_summary_lc}",
        "You might want to ask about this: {social_knowledge_summary_lc}",
        "This is the part you might actually use: {social_knowledge_summary_lc}",
    ),
    "social_knowledge_relationship": (
        "People-wise, {social_knowledge_summary_lc}",
        "From what I've heard, {social_knowledge_summary_lc}",

...
DEFAULT_SITE_SERVICES_BY_ARCHETYPE = {
    ...
    "butcher_shop": ("butcher_prepare",),
    "casino": ("slots", "video_poker", "keno", "roulette", "craps", "baccarat", "three_card_poker", "casino_holdem", "plinko", "crash", "twenty_one"),
    ...
    "flophouse": ("rest",),
    "gaming_hall": ("video_poker", "keno", "plinko", "crash", "roulette", "craps", "baccarat", "three_card_poker"),
    "hair_studio": ("appearance_style",),
    "herbalist_camp": ("herbal_care", "herbal_prepare", "herbal_recipe_sales"),
    "herbalist_shop": ("herbal_care", "herbal_prepare", "herbal_recipe_sales"),
    "hotel": ("rest",),
    ...
    "roadhouse": ("shuttle_transit", "coach_transit", "business_management"),

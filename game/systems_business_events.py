        ...
        if phase == "opening":
            events = [
                ...
                },
                {
                    "phase": "staff_handoff",
                    "label": "staff handoff",
                    "street_label": "staff cycling through the door",
        ...
        if phase in {"back_office", "steady_trade"}:
            events = [
                ...
                },
                {
                    "phase": "shift_handoff",
                    "label": "shift handoff",
                    "street_label": "staff rotating through the door",
        ...
        if phase in {"shift_work", "steady_ops"}:
            events = [
                ...
                },
                {
                    ...
                    "street_label": "dispatch traffic clipping the business",
        ...
        if phase == "settled_evening":
            return (
                ...
                },
                {
                    ...
                    "entry_sentence": "A small mutual aid table is making the storefront feel like a soft landing spot instead of a pass-through.",
                    "emphasis": "residential",
                    "perimeter_bonus": 1.6,
                },
            )
    ...
    if open_now or phase == "active_floor":
        return (
            ...
            },
            {
                ...
                "entry_sentence": "A sudden injury has turned the doorway into a rough treatment spot, with somebody working fast to keep a hurt person steady.",
                "emphasis": "front",
                "perimeter_bonus": 1.7,
            },
        )

...
WORLD_PALETTE: tuple[WorldPaletteRow, ...] = (
    ...
    _row("weather_rain", (132, 194, 232), 117, "cyan", attrs=("bold",), tags=("weather", "rain")),
    _row("weather_sleet", (184, 214, 232), 153, "cyan", tags=("weather", "sleet")),
    _row("weather_snow", (238, 246, 250), 255, "white", attrs=("bold",), tags=("weather", "snow")),
    _row("weather_fog", (172, 184, 190), 250, "white", attrs=("dim",), tags=("weather", "fog")),
    _row("weather_tornado", (108, 116, 122), 244, "white", attrs=("bold",), tags=("weather", "tornado")),
    _row("weather_tornado_debris", (148, 116, 82), 137, "yellow", attrs=("bold",), tags=("weather", "tornado", "debris")),
    _row("weather_ground_snow", (224, 237, 241), 255, "white", tags=("weather", "ground", "snow")),
    _row("weather_ground_ice", (158, 211, 229), 153, "cyan", attrs=("bold",), tags=("weather", "ground", "ice")),
    _row("weather_ground_soft", (104, 82, 60), 94, "yellow", attrs=("dim",), tags=("weather", "ground", "mud")),
    _row("weather_ground_puddle", (72, 132, 166), 67, "cyan", tags=("weather", "ground", "water")),
    _row("weather_ground_flood", (62, 119, 153), 31, "cyan", attrs=("bold",), tags=("weather", "ground", "flood")),

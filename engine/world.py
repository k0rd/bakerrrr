...
class World:
    ...
    OPTIONAL_BUILDINGS_BY_DISTRICT = {
        ...
        "residential": ("daycare", "laundromat", "pharmacy", "bookshop", "hardware_store", "outfitter", "outfitter", "surplus_store", "thrift_store", "service_station", "barbershop", "salon", "top_shop", "bottom_shop", "shoe_shop", "hair_studio"),
        "downtown": ("hotel", "courthouse", "jail", "jail", "metro_exchange", "courier_office", "gallery", "casino", "tavern", "outfitter", "salon", "barbershop", "top_shop", "dress_shop", "shoe_shop", "outerwear_shop", "headwear_shop", "jewelry_shop", "accessory_shop", "hair_studio", "makeup_counter", "tattoo_parlor"),
        "slums": ("chop_shop", "junk_market", "soup_kitchen", "flophouse", "street_kitchen", "jail", "thrift_store", "barbershop", "tattoo_parlor", "accessory_shop", "shoe_shop"),
        "corporate": ("data_center", "co_working_hub", "biotech_clinic", "brokerage", "media_lab", "salon", "jewelry_shop", "makeup_counter", "dress_shop"),
        "military": ("command_center", "motor_pool", "field_hospital", "recruitment_office", "supply_bunker", "prison", "surplus_store"),
        "entertainment": ("theater", "music_venue", "gaming_hall", "karaoke_box", "pool_hall", "casino", "salon", "barbershop", "hair_studio", "makeup_counter", "tattoo_parlor", "jewelry_shop", "accessory_shop", "dress_shop"),
    }

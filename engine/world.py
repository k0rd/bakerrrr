...
class World:
    ...
    OPTIONAL_BUILDINGS_BY_DISTRICT = {
        ...
        "residential": ("daycare", "laundromat", "pharmacy", "bookshop", "hardware_store", "outfitter", "outfitter", "surplus_store", "thrift_store", "service_station", "barbershop", "salon", "top_shop", "bottom_shop", "shoe_shop", "hair_studio", "clothing_superstore", "employment_agency"),
        "downtown": ("hotel", "courthouse", "jail", "jail", "metro_exchange", "courier_office", "employment_agency", "bounty_office", "gallery", "casino", "tavern", "outfitter", "clothing_superstore", "salon", "barbershop", "top_shop", "dress_shop", "shoe_shop", "outerwear_shop", "headwear_shop", "jewelry_shop", "accessory_shop", "hair_studio", "makeup_counter", "tattoo_parlor"),
        ...
        "corporate": ("data_center", "co_working_hub", "biotech_clinic", "brokerage", "media_lab", "employment_agency", "salon", "jewelry_shop", "makeup_counter", "dress_shop", "clothing_superstore"),

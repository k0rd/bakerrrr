...
class World:
    ...
    OPTIONAL_BUILDINGS_BY_DISTRICT = {
        "industrial": ("recycling_plant", "auto_garage", "freight_depot", "cold_storage", "tool_depot", "contractor_office", "service_station"),
        "residential": ("daycare", "laundromat", "pharmacy", "bookshop", "hardware_store", "outfitter", "outfitter", "surplus_store", "thrift_store", "service_station"),

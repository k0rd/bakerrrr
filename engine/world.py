...
class World:
    ...
    OPTIONAL_BUILDINGS_BY_DISTRICT = {
        ...
        "residential": ("daycare", "laundromat", "pharmacy", "bookshop", "hardware_store", "outfitter", "outfitter", "surplus_store", "thrift_store", "service_station", "barbershop", "salon", "top_shop", "bottom_shop", "shoe_shop", "hair_studio", "clothing_superstore", "employment_agency", "butcher_shop"),
        "downtown": ("hotel", "courthouse", "jail", "jail", "metro_exchange", "courier_office", "employment_agency", "bounty_office", "gallery", "casino", "tavern", "outfitter", "clothing_superstore", "salon", "barbershop", "top_shop", "dress_shop", "shoe_shop", "outerwear_shop", "headwear_shop", "jewelry_shop", "accessory_shop", "hair_studio", "makeup_counter", "tattoo_parlor", "butcher_shop"),
        "slums": ("chop_shop", "junk_market", "soup_kitchen", "flophouse", "street_kitchen", "jail", "thrift_store", "barbershop", "tattoo_parlor", "accessory_shop", "shoe_shop", "butcher_shop"),

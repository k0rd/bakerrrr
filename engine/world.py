...
class World:
    ...
    CAREERS_BY_ARCHETYPE = {
        ...
        "ranger_hut": ("wildlife_ranger", "game_warden", "conservation_officer", "trail_keeper", "ecology_clerk"),
        "firewatch_tower": ("firewatch_keeper", "range_spotter", "signal_keeper", "fire_investigator"),

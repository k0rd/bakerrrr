...
from game.symbolic_palette import curses_symbolic_palette_entries
...
class CursesView:
    ...
    def _init_colors(self):
        ...
        def _register_symbolic_palette():
            _register_palette_entries(curses_symbolic_palette_entries(colors))

        if colors >= 256:
            _register_world_palette()
            _register_symbolic_palette()
